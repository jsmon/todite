...
const ApiDocsV1 = (): React.ReactElement<{
            ...
            <main>
                <section id="user" className="user p-2">
                    ...
                    <section>
                        ...
                        <section className="request-body p-2">
                            <h4 className="font-bold">Request Body</h4>
                            <ul>
                                <li>
                                    <code>settings</code> - Your user settings
                                </li>
                            </ul>
                        </section>
                        <section className="data-structure p-2">
                ...
                <section id="api-key" className="api-key p-2">
                    <h2 className="font-bold text-2xl"><code>/api/v1/api-key</code></h2>
                    <section>
                        <h3 className="font-bold text-lg"><code>GET</code></h3>
                        <section className="description p-2">
                            <h4 className="font-bold">Description</h4>
                            <p className="description">Get your API key</p>
                        </section>
                        <section className="headers p-2">
                            <h4 className="font-bold">Headers</h4>
                            <ul>
                        ...
                        <section className="data-structure p-2">
                            ...
                            <ul>
                                <li>
                                    <code>apiKey</code> - <Link href="/docs/api-key"><a className="text-blue-600 hover:underline focus:underline">Your API key</a></Link>
                                </li>
                            </ul>
                        </section>
                        <section className="errors p-2">
                    ...
                    <section>
                        ...
                        <section className="description p-2">
                            <h4 className="font-bold">Description</h4>
                            <p className="description">Regenerate your API key</p>
                        </section>
                        <section className="headers p-2">
                            <h4 className="font-bold">Headers</h4>
                            <ul>
                        ...
                        <section className="query-parameters p-2">
                            ...
                            <ul>
                                <li>
                                    <code>api_key</code> - <Link href="/docs/api-key"><a className="text-blue-600 hover:underline focus:underline">Your current API key</a></Link>
                                </li>
                            </ul>
                        </section>
                        <section className="data-structure p-2">
                            ...
                            <ul>
                                <li>
                                    <code>apiKey</code> - <Link href="/docs/api-key"><a className="text-blue-600 hover:underline focus:underline">Your new API key</a></Link>
                                </li>
                            </ul>
                        </section>
                        <section className="errors p-2">
                            ...
                            <ul>
                                <li>
                                    <code>status</code> - <code>number (404)</code> - The HTTP status code (in a <code>PUT / PATCH</code> request, it can <i>only</i> be <code>404</code>)
                                </li>
                                <li>
                                    <code>message</code> - <code>string</code> - An error message
                                </li>
                ...
                <section id="todos" className="todos p-2">
                    <h2 className="font-bold text-2xl"><code>/api/v1/todos</code></h2>
                    <section>
                        <h3 className="font-bold text-lg"><code>GET</code></h3>
                        <section className="description p-2">
                            <h4 className="font-bold">Description</h4>
                            <p className="description">Get all of your to-dos</p>
                        </section>
                        <section className="headers p-2">
                            <h4 className="font-bold">Headers</h4>
                            <ul>
                        ...
                        <section className="data-structure p-2">
                            <h4 className="font-bold">Data Structure</h4>
                            <p>This API endpoint returns an array of objects which have this data structure:</p>
                            <ul>
                                <li>
                                    <code>_id</code> - <code>string</code> - The to-do's ID (generated by MongoDB)
                                </li>
                                <li>
                                    <code>name</code> - <code>string</code> - What to do
                                </li>
                                <li>
                                    <code>completed</code> - <code>boolean</code> - Whether the to-do has been done
                                </li>
                                <li>
                                    <code>date</code> (optional) - <code>Date</code> - When the to-do needs to be done by (or <code>undefined</code>)
                                </li>
                            </ul>
                        </section>
                    </section>
                    <section>
                        ...
                        <section className="description p-2">
                            <h4 className="font-bold">Description</h4>
                            <p className="description">Add a new to-do</p>
                        </section>
                        <section className="headers p-2">
                            <h4 className="font-bold">Headers</h4>
                            <ul>
                        ...
                        <section className="request-body p-2">
                            ...
                            <ul>
                                ...
                                <li>
                                    <code>date</code> - <code>boolean</code> - When the to-do needs to be done by
                                </li>
                            </ul>
                        </section>
                        <section className="data-structure p-2">
                        ...
                        <section className="errors p-2">
                            ...
                            <ul>
                                <li>
                                    <code>status</code> - <code>number (400)</code> - The HTTP status code (in a <code>POST</code> request, it can <i>only</i> be <code>400</code>)
                                </li>
                                <li>
                                    <code>message</code> - <code>string</code> - An error message
                                </li>
                ...
                <section id="todo-id" className="todos p-2">
                    <h2 className="font-bold text-2xl"><code>/api/v1/todo/[id]</code></h2>
                    <section>
                        <h3 className="font-bold text-lg"><code>GET</code></h3>
                        <section className="description p-2">
                            <h4 className="font-bold">Description</h4>
                            <p className="description">Get a specific to-do</p>
                        </section>
                        <section className="headers p-2">
                            <h4 className="font-bold">Headers</h4>
                            <ul>
                        ...
                        <section className="errors p-2">
                            ...
                            <ul>
                                <li>
                                    <code>status</code> - <code>number (404 | 403)</code> - The HTTP status code (in a <code>GET</code> request, it can <i>only</i> be <code>404</code> or <code>403</code>)
                                </li>
                                <li>
                                    <code>message</code> - <code>string</code> - An error message
                                </li>
                    ...
                    <section>
                        ...
                        <section className="description p-2">
                            <h4 className="font-bold">Description</h4>
                            <p className="description">Update a to-do</p>
                        </section>
                        <section className="headers p-2">
                            <h4 className="font-bold">Headers</h4>
                            <ul>
                        ...
                        <section className="errors p-2">
                            ...
                            <ul>
                                <li>
                                    <code>status</code> - <code>number (404 | 403)</code> - The HTTP status code (in a <code>PUT / PATCH</code> request, it can <i>only</i> be <code>404</code> or <code>403</code>)
                                </li>
                                <li>
                                    <code>message</code> - <code>string</code> - An error message
                                </li>
                    ...
                    <section>
                        ...
                        <section className="description p-2">
                            <h4 className="font-bold">Description</h4>
                            <p className="description">Delete a to-do</p>
                        </section>
                        <section className="headers p-2">
                            <h4 className="font-bold">Headers</h4>
                            <ul>
                        ...
                        <section className="data-structure p-2">
                            ...
                            <ul>
                                <li>
                                    <code>success</code> - <code>boolean (true)</code> - Whether the to-do has been succesfully deleted (the only point of this response is to make sure the client knows the API worked)
                                </li>
                            </ul>
                        </section>
                        <section className="errors p-2">
                            ...
                            <ul>
                                <li>
                                    <code>status</code> - <code>number (404 | 403)</code> - The HTTP status code (in a <code>DELETE</code> request, it can <i>only</i> be <code>404</code> or <code>403</code>)
                                </li>
                                <li>
                                    <code>message</code> - <code>string</code> - An error message
                                </li>
